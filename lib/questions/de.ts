...
// ---------------------------------------------------------------------------
// German question bank — PLACEHOLDER.
//
...
// for any category with no German questions, and shows a small notice to
// the player that the questions are still in English.
//
// To add real German questions: copy the shape from lib/questions/en.ts
...
// and any quoted Scripture reviewed by a native speaker / trusted German
