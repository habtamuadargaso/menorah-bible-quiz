...
// ---------------------------------------------------------------------------
// Arabic question bank — PLACEHOLDER.
//
...
// for any category with no Arabic questions, and shows a small notice to
// the player that the questions are still in English.
//
// To add real Arabic questions: copy the shape from lib/questions/en.ts
...
// and any quoted Scripture reviewed by a native speaker / trusted Arabic
// Bible translation before publishing — do not auto-translate verse text.
// ---------------------------------------------------------------------------
export const QUESTIONS_AR: Question[] = [];
