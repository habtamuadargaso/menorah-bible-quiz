...
// ---------------------------------------------------------------------------
// Spanish question bank — PLACEHOLDER.
//
...
//
// To add real Spanish questions: copy the shape from lib/questions/en.ts
...
// and any quoted Scripture reviewed by a native speaker / trusted Spanish
