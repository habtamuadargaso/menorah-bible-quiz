# Accuracy, Blockers, and Intentional Omissions

## Included because verified

- Solo Quiz and its 10-level journey
...
- “Fully offline”: only Friends Battle and selected local functionality are described narrowly; Live Battle requires internet.

## Asset notes

- Live Battle imagery uses a real temporary host lobby with the QR code, room code, and join URL redacted from both raw and final files.
- Leaderboard imagery shows the real empty/guest state rather than invented rankings.
- Profile imagery shows the real guest state rather than fabricated progress.
- Results and feedback scenes came from completed real app quiz runs captured during prior visual QA in this repository.
