    ...
    <div>
      ...
      <section className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-5">
        ...
        <p className="mt-1 text-xs text-slate-500">
          Changing this here does not change the player-facing language list. Release visibility is controlled centrally
          in lib/i18n/locales.ts; this setting only affects which languages the dashboard highlights by default.
        </p>
      </section>
